...
import type { AppliancePluginInstance, Room, RoomMember, RoomState } from '@netless/appliance-plugin';
import { TopTools } from './view/topTools';
import ScenePreview from './view/scenePreview';
      ...
      if (window.room) {
        ...
        switch (toolsKey) {
          ...
          case EToolsKey.PencilEraser:
            _object.setMemberState({currentApplianceName: ApplianceNames.pencilEraser, pencilEraserSize: 3});
            break;
