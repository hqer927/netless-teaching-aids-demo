...
import type { AutoDrawPlugin } from '@netless/appliance-plugin';
    ...
    const _strokeType = useMemo(() => {
        if(toolsKey === EToolsKey.Pencil || toolsKey === EToolsKey.LaserPen){
            ...
            const onChange = (checked: boolean) => {
                if (checked) {
                    (window.autoDrawPlugin as AutoDrawPlugin).mount();
                } else {
                    (window.autoDrawPlugin as AutoDrawPlugin).unMount();
                }
            }
            return (
                <Popover
                    ...
                    content={()=>{
                        ...
                        return (
                            <>
                                autoDraw: <Switch onChange={onChange} />
                                <Divider />
