...
import { AppstoreOutlined, BorderOutlined, ClockCircleOutlined, FileMarkdownOutlined, FilePdfOutlined, FilePptOutlined, FileWordOutlined } from '@ant-design/icons';
...
const AppTools = () => {
    ...
    //     const scenePath = '/ppt/4d9409def2a24dab97034fc7ab5ef5c5';
    ...
    const insertLitteBoardViewer = async(): Promise<void> => {
    ...
    return <div>
            <Flex>
                ...
                <Button 
                    type={'text'} 
                    icon={<BorderOutlined />} 
                    onClick={insertLitteBoardViewer}
                />
            </Flex>
        </div>
}
